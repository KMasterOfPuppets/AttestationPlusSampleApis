...
{
    public class CCCRemoveAllMoverAzureMembershipsAction : IApiProviderFor<QER.CompositionApi.Portal.PortalApiProject>, IApiProvider
    {
        public void Build(IApiBuilder builder)
        {
            builder.AddMethod(Method.Define("webportalplus/removeallmoverazurememberships/action")
                .Handle<PostedID>("POST", async (posted, qr, ct) =>
                {
                    ...
                    using (var reader = runner.SqlExecute("CCC_DE_MoverAttestationSubAzureTeamsGroups", new[]
                    {
