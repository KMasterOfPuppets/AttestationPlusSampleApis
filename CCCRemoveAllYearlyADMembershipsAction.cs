...
{
    public class CCCRemoveAllYearlyADMembershipsAction : IApiProviderFor<QER.CompositionApi.Portal.PortalApiProject>, IApiProvider
    {
        public void Build(IApiBuilder builder)
        {
            builder.AddMethod(Method.Define("webportalplus/removeallyearlyadmemberships/action")
                .Handle<PostedID>("POST", async (posted, qr, ct) =>
                {
                    ...
                    using (var reader = await runner.SqlExecuteAsync("CCC_DE_YearlyAttestationSubADSGroup", new[]
