...
{
    public class CCCRemoveAllYearlyLAMembershipsAction : IApiProviderFor<QER.CompositionApi.Portal.PortalApiProject>, IApiProvider
    {
        public void Build(IApiBuilder builder)
        {
            builder.AddMethod(Method.Define("webportalplus/removeallyearlylamemberships/action")
                .Handle<PostedID>("POST", async (posted, qr, ct) =>
                {
                    ...
                    using (var reader = await runner.SqlExecuteAsync("CCC_DE_YearlyAttestationSubLocalAdmin", new[]
